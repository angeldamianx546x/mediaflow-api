...
public interface ContentRepository extends JpaRepository<Content, Integer> {
    ...
    @Query("SELECT DISTINCT c FROM Content c LEFT JOIN FETCH c.categories WHERE c.user.userId = :userId AND c.contentType = :contentType")
    ...
    @Query("SELECT DISTINCT c FROM Content c LEFT JOIN FETCH c.categories WHERE c.user.userId = :userId")
